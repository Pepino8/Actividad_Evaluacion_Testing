...
public class UserController {
    ...
    public UserController(UserService userService, UserControllerAdvice userControllerAdvice) {
        this.userService = userService;
        this.userControllerAdvice = userControllerAdvice;
    }
    ...
    ApiResponse<UserWrapper> registerUser(@RequestBody UserRequest request) {
        return new ApiResponse<>("Usuario registrado exitosamente", new UserWrapper( userService.registerUser(request)), null);
    }
    ...
    ApiResponse<UserWrapper> getUserById(@PathVariable Long id) {
        return new ApiResponse<>("User encontrado", new UserWrapper(userService.getUserById(id)), null);
    }
